...
throw e;}var m=a[l](c,l,g,p,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(P){m=P}!m||m instanceof Error||C((g||"React class")+": type specification of "+p+" `"+l+"` is invalid; the type checker function must return `null` or an `Error` but returned a "+typeof m+". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).");if(m instanceof Error&&!(m.message in D)){D[m.message]=!0;var d=
f?f():"";C("Failed "+p+" type: "+m.message+(null!=d?d:""))}}}function x(){return null}function E(a){var c=a.children,p=a.timeout;a=a.window;var g=n.useRef(null);null==g.current&&(g.current=I.createBrowserHistory({window:a}));return n.createElement(h.Router,{children:c,history:g.current,timeout:p})}function F(a){var c=a.children,p=a.timeout;a=a.window;var g=n.useRef(null);null==g.current&&(g.current=I.createHashHistory({window:a}));return n.createElement(h.Router,{children:c,history:g.current,timeout:p})}
function G(a){K(a.message,a.when);return null}function K(a,c){var p=n.useCallback(function(g){window.confirm(a)&&g.retry()},[a]);h.useBlocker(p,c)}n=n&&n.hasOwnProperty("default")?n["default"]:n;var L=u(function(a,c){(function(){function a(a){if("object"===typeof a&&null!==a){var g=a.$$typeof;switch(g){case l:switch(a=a.type,a){case b:case k:case m:case h:case d:case y:return a;default:switch(a=a&&a.$$typeof,a){case r:case w:case z:case A:case n:return a;default:return g}}case e:return g}}}function g(b){return a(b)===
k}Object.defineProperty(c,"__esModule",{value:!0});var f="function"===typeof Symbol&&Symbol.for,l=f?Symbol.for("react.element"):60103,e=f?Symbol.for("react.portal"):60106,m=f?Symbol.for("react.fragment"):60107,d=f?Symbol.for("react.strict_mode"):60108,h=f?Symbol.for("react.profiler"):60114,n=f?Symbol.for("react.provider"):60109,r=f?Symbol.for("react.context"):60110,b=f?Symbol.for("react.async_mode"):60111,k=f?Symbol.for("react.concurrent_mode"):60111,w=f?Symbol.for("react.forward_ref"):60112,y=f?
...
}catch(Z){}},q=f=function(b,a){if(void 0===a)throw Error("`lowPriorityWarningWithoutStack(condition, format, ...args)` requires a warning message argument");if(!b){for(var k=arguments.length,g=Array(2<k?k-2:0),c=2;c<k;c++)g[c-2]=arguments[c];T.apply(void 0,[a].concat(g))}},t=!1;c.typeOf=a;c.AsyncMode=b;c.ConcurrentMode=k;c.ContextConsumer=r;c.ContextProvider=n;c.Element=l;c.ForwardRef=w;c.Fragment=m;c.Lazy=z;c.Memo=A;c.Portal=e;c.Profiler=h;c.StrictMode=d;c.Suspense=y;c.isValidElementType=function(a){return"string"===
typeof a||"function"===typeof a||a===m||a===k||a===h||a===d||a===y||a===Q||"object"===typeof a&&null!==a&&(a.$$typeof===z||a.$$typeof===A||a.$$typeof===n||a.$$typeof===r||a.$$typeof===w||a.$$typeof===R||a.$$typeof===S||a.$$typeof===v)};c.isAsyncMode=function(k){t||(t=!0,q(!1,"The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API."));return g(k)||a(k)===b};c.isConcurrentMode=g;c.isContextConsumer=
function(b){return a(b)===r};c.isContextProvider=function(b){return a(b)===n};c.isElement=function(a){return"object"===typeof a&&null!==a&&a.$$typeof===l};c.isForwardRef=function(b){return a(b)===w};c.isFragment=function(b){return a(b)===m};c.isLazy=function(b){return a(b)===z};c.isMemo=function(b){return a(b)===A};c.isPortal=function(b){return a(b)===e};c.isProfiler=function(b){return a(b)===h};c.isStrictMode=function(b){return a(b)===d};c.isSuspense=function(b){return a(b)===y}})()});(function(a){return a&&
...
return new g("Invalid "+e+" `"+f+"` supplied to `"+(d+"`."))})},shape:function(a){return f(function(b,c,d,e,f){b=b[c];c=m(b);if("object"!==c)return new g("Invalid "+e+" `"+f+"` of type `"+c+"` supplied to `"+(d+"`, expected `object`."));for(var k in a)if(c=a[k])if(c=c(b,k,d,e,f+"."+k,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED"))return c;return null})},exact:function(a){return f(function(b,c,d,e,f){var k=b[c],h=m(k);if("object"!==h)return new g("Invalid "+e+" `"+f+"` of type `"+h+"` supplied to `"+
(d+"`, expected `object`."));h=W({},b[c],a);for(var l in h){h=a[l];if(!h)return new g("Invalid "+e+" `"+f+"` key `"+l+"` supplied to `"+d+"`.\nBad object: "+JSON.stringify(b[c],null,"  ")+"\nValid keys: "+JSON.stringify(Object.keys(a),null,"  "));if(h=h(k,l,d,e,f+"."+l,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED"))return h}return null})}};g.prototype=Error.prototype;r.checkPropTypes=B;r.resetWarningCache=B.resetWarningCache;return r.PropTypes=r},d=u(function(a){a.exports=Y(M.isElement,!0)});E.displayName=
"BrowserRouter";E.propTypes={children:d.node,timeout:d.number,window:d.object};F.displayName="HashRouter";F.propTypes={children:d.node,timeout:d.number,window:d.object};var t=n.forwardRef(function(a,c){var d=a.as;d=void 0===d?"a":d;var e=a.onClick,f=a.replace,l=void 0===f?!1:f,t=a.state,m=a.target,q=a.to;a=J(a,"as onClick replace state target to".split(" "));f=h.useHref(q);var x=h.useNavigate(),u=h.useLocation(),r=h.useResolvedLocation(q);return n.createElement(d,v({},a,{href:f,onClick:function(a){e&&
e(a);a.defaultPrevented||0!==a.button||m&&"_self"!==m||a.metaKey||a.altKey||a.ctrlKey||a.shiftKey||(a.preventDefault(),a=r.pathname===u.pathname&&r.search===u.search&&r.hash===u.hash,x(q,{replace:!!l||a,state:t}))},ref:c,target:m}))});t.displayName="Link";t.propTypes={as:d.elementType,onClick:d.func,replace:d.bool,state:d.object,target:d.string,to:d.oneOfType([d.string,d.shape({pathname:d.string,search:d.string,hash:d.string})]).isRequired};var H=n.forwardRef(function(a,c){var d=a["aria-current"];
...
{"aria-current":d.oneOf("page step location date time true".split(" ")),activeClassName:d.string,activeStyle:d.object,className:d.string,style:d.object,to:d.oneOfType([d.string,d.shape({pathname:d.string,search:d.string,hash:d.string})]).isRequired});G.displayName="Prompt";G.propTypes={message:d.string,when:d.bool};Object.defineProperty(e,"MemoryRouter",{enumerable:!0,get:function(){return h.MemoryRouter}});Object.defineProperty(e,"Navigate",{enumerable:!0,get:function(){return h.Navigate}});Object.defineProperty(e,
"Outlet",{enumerable:!0,get:function(){return h.Outlet}});Object.defineProperty(e,"Redirect",{enumerable:!0,get:function(){return h.Redirect}});Object.defineProperty(e,"Route",{enumerable:!0,get:function(){return h.Route}});Object.defineProperty(e,"Router",{enumerable:!0,get:function(){return h.Router}});Object.defineProperty(e,"Routes",{enumerable:!0,get:function(){return h.Routes}});Object.defineProperty(e,"createRoutesFromChildren",{enumerable:!0,get:function(){return h.createRoutesFromChildren}});
Object.defineProperty(e,"generatePath",{enumerable:!0,get:function(){return h.generatePath}});Object.defineProperty(e,"matchRoutes",{enumerable:!0,get:function(){return h.matchRoutes}});Object.defineProperty(e,"resolveLocation",{enumerable:!0,get:function(){return h.resolveLocation}});Object.defineProperty(e,"useBlocker",{enumerable:!0,get:function(){return h.useBlocker}});Object.defineProperty(e,"useHref",{enumerable:!0,get:function(){return h.useHref}});Object.defineProperty(e,"useLocation",{enumerable:!0,
get:function(){return h.useLocation}});Object.defineProperty(e,"useMatch",{enumerable:!0,get:function(){return h.useMatch}});Object.defineProperty(e,"useNavigate",{enumerable:!0,get:function(){return h.useNavigate}});Object.defineProperty(e,"useOutlet",{enumerable:!0,get:function(){return h.useOutlet}});Object.defineProperty(e,"useParams",{enumerable:!0,get:function(){return h.useParams}});Object.defineProperty(e,"useResolvedLocation",{enumerable:!0,get:function(){return h.useResolvedLocation}});
Object.defineProperty(e,"useRoutes",{enumerable:!0,get:function(){return h.useRoutes}});e.BrowserRouter=E;e.HashRouter=F;e.Link=t;e.NavLink=H;e.Prompt=G;e.usePrompt=K;Object.defineProperty(e,"__esModule",{value:!0})});
=======
/**
